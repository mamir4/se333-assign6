...
public class BookStoreTest {
        ...
        void depaulBookstoreTest() {
                ...
                page1.locator(
                                ...
                                .click();
                page1.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("JBL Quantum True Wireless"))
                                .click();
                ...
                assertThat(page1.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Cart 1 items")))
                                .isVisible();
                ...
                assertThat(page1.getByLabel("main"))
                                .containsText("JBL Quantum True Wireless Noise Cancelling Gaming Earbuds- Black");
                assertThat(page1.getByLabel("main")).containsText("$164.98");
                assertThat(page1.getByRole(AriaRole.TEXTBOX,
                ...
                page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Proceed To Checkout")).first()
                                .click();
                ...
                page1.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("First Name (required)"))
                                .fill("malaekaa");
                page1.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Last Name (required)"))
                                .fill("amir");
                ...
                page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Remove product JBL Quantum"))
                                .click();
                assertThat(page1.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Cart 0 items")))
                                .isVisible();
        }
