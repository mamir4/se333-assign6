...
public class BookStoreTest {
    ...
    void depaulBookstoreTest() {
        ...
        assertThat(page1.getByLabel("main").getByRole(AriaRole.HEADING)).containsText("JBL Quantum True Wireless Noise Cancelling Gaming Earbuds- Black");
        ...
        assertThat(page1.getByLabel("main")).containsText("$164.98");
        assertThat(page1.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Quantity, edit and press"))).hasValue("1");
        ...
        page1.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("First Name (required)")).fill("malaekaa");
